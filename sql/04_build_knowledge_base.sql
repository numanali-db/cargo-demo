...
'Northwind Air Cargo Perishables SOP', ARRAY('perishables','per','flowers','fresh'),
CURRENT_TIMESTAMP()),
...
'IATA LAR, Northwind Air Cargo AVI Manual', ARRAY('avi','animals','horses','falcons'),
CURRENT_TIMESTAMP()),

('KB-005', 'special_cargo', 'Valuables (VAL) Handling',
'Valuables include cash, bullion, banknotes, securities, jewelry, precious stones. Vault storage required at origin and destination. Armored ground transport. Maximum value per AWB typically capped at limits per Warsaw/Montreal Convention unless special declared value applies. Premium 80-100% over GCR. Strict chain of custody documentation. Northwind Air Cargo offers VAL service on LHR-JFK, LHR-LAX, LHR-HKG, LHR-DXB (interline) lanes. Brink''s and Loomis are common forwarder partners.',
'Northwind Air Cargo VAL SOP', ARRAY('val','valuables','bullion','jewelry'),
CURRENT_TIMESTAMP()),
...
'IATA DGR, Northwind Air Cargo DG Acceptance', ARRAY('dgr','dangerous_goods','lithium'),
CURRENT_TIMESTAMP()),

('KB-007', 'pricing_strategy', 'Forwarder Discount Tiers',
'Northwind Air Cargo forwarder tiers: Platinum (DSV, K+N, DHL Global) receive 10-12% off published rates, dedicated capacity allocations on key lanes, 30-day credit terms, and named cargo account manager. Gold tier (Expeditors, CEVA, Bollore) receive 6-8% off, named contact, 30-day terms. Silver (Yusen, Geodis, Nippon Express) receive 3-4% off, 14-day terms. Bronze and direct shippers pay published rates. Annual contract negotiation in Q4 for following calendar year.',
'Northwind Air Cargo Commercial Cargo Manual 2026', ARRAY('forwarder','discount','tier','contract'),
CURRENT_TIMESTAMP()),
...
'Northwind Air Cargo Yield Strategy 2026', ARRAY('yield','pricing','capacity','overbooking'),
CURRENT_TIMESTAMP()),
...
'Northwind Air Cargo Rate Card 2026', ARRAY('capacity','premium','discount','tactical'),
CURRENT_TIMESTAMP()),

('KB-010', 'competitive', 'Key Competitor Positioning',
'British Airways IAG Cargo: Same UK origin, similar lane structure. Strong on US transatlantic. Aggressive on pharma. Lufthansa Cargo: Frankfurt hub, broader European feed, premium pharma. Air France-KLM Cargo: AMS and CDG hubs, strong Asia connectivity. Emirates SkyCargo: DXB hub, dominant on India and Africa. Delta and United: US carriers, transatlantic competition only on direct lanes. Position Northwind Air Cargo on: UK-India lanes (#1 share), UK-US pharma corridor, Caribbean leisure cargo, and Lagos premium freight.',
'Northwind Air Cargo Commercial Intel Brief Q1 2026', ARRAY('competitor','iag','lufthansa','emirates'),
CURRENT_TIMESTAMP()),

('KB-011', 'lanes', 'LHR-JFK Lane Characteristics',
'LHR-JFK is Northwind Air Cargo''s flagship cargo lane, operating 3x daily. Average cargo capacity 18,000 kg per flight. Strong demand for transatlantic finance documents, e-commerce, pharma. Competition: BA IAG Cargo (4x daily), AA Cargo (2x daily), Delta Cargo (3x daily JFK-LHR/LGW). Average yield £2.85/kg general cargo, £4.10/kg pharma, £5.50/kg express. Peak demand: Mon-Wed eastbound, Thu-Fri westbound. Load factor target 80%.',
'Northwind Air Cargo LHR-JFK Brief', ARRAY('lhr-jfk','lane','transatlantic'),
CURRENT_TIMESTAMP()),

('KB-012', 'lanes', 'LHR-DEL / LHR-BOM India Lanes',
'India lanes (LHR-DEL, LHR-BOM, LHR-BLR) are Northwind Air Cargo''s highest-yield routes. Strong demand for: pharma (India is global generic pharma hub), perishables (flowers, vegetables), garments, IT equipment. Average yield £3.40-3.55/kg. Capacity 22,000 kg per B789 flight. Competition: Emirates via DXB (still 30% lower yield due to longer routing), Air India direct, IndiGo (limited cargo). Red Sea disruption 2024 increased Northwind share by 18%. Mumbai/Delhi pharma corridor: 35% of LHR-India cargo revenue.',
'Northwind Air Cargo India Cargo Strategy', ARRAY('india','del','bom','blr','pharma'),
CURRENT_TIMESTAMP()),
...
'HMRC Cargo Manual, Northwind Air Cargo Customs Guide', ARRAY('customs','brexit','hmrc','aeo'),
CURRENT_TIMESTAMP()),
...
'Northwind Air Cargo AOG Procedure', ARRAY('aog','aircraft','urgent','24x7'),
CURRENT_TIMESTAMP()),
...
'Northwind Air Cargo Capacity Management SOP', ARRAY('no_show','offload','overbooking','capacity'),
CURRENT_TIMESTAMP());
